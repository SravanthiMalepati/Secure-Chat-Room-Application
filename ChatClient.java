...
public class ChatClient {
    ...
    public int connect(String userName,
        ...
        try {
            ...
            //  Loading user's keystore...
            System.out.println( "[PROCESS -1-] : Loading user's keystore..." );
            FileInputStream inputStream = new FileInputStream( "/Users/sravanthimalepati/Downloads/Secure-Chat-Room-Service-master/ChatRoom-Service/Chat/keystores/KeyStoreClient" );
            ...
            // Check users certificate with username
            ...
            if (!userKeyStore.isCertificateEntry( loginName )) {
                ...
                ca_socket = new Socket( caHost, caPort );
                ...
                // send CA username and RSA public key
                ...
                out.close();
                in.close();
                //  Save the certificate in its keystore
                userKeyStore.setCertificateEntry( loginName, userCertificate );
                FileOutputStream keyStoreStream = new FileOutputStream("/Users/sravanthimalepati/Downloads/Secure-Chat-Room-Service-master/ChatRoom-Service/Chat/keystores/KeyStoreClient" );
